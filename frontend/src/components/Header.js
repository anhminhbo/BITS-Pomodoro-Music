...
const Header = () => {
  ...
  const handleCloseAndOpenChangePass = () => {
    ...
    document.getElementById("changePass-old-password-message").style.display =
      "none";
    document.getElementById("changePass-new-password-message").style.display =
      "none";
    document.getElementById("changePass-con-password-message").style.display =
      "none";
    document.getElementById("changePass-new-password-message-2").style.display =
      "none";
  };
      ...
      if (err.response.data.errCode === 112) {
        ...
        if (err.response.data.errCode === 102) {
          document.getElementById(
            "changePass-old-password-message"
          ).style.display = "block";
        } else {
          document.getElementById(
            "changePass-old-password-message"
        ...
        if (err.response.data.errCode === 122) {
          document.getElementById(
            "changePass-new-password-message-2"
          ).style.display = "block";
        } else {
          document.getElementById(
            "changePass-new-password-message-2"
    ...
    <>
      <div id="changePass-outer">
        ...
        >
          ...
          />
          <div
            id="changePass-old-password-message"
            className="changePass-message"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="13"
              height="13"
              fill="currentColor"
              className="bi bi-exclamation-circle-fill changePass-message-icon"
              viewBox="0 0 16 16"
            >
              <path d="M16 8A8 8 0 1 1 0 8a8 8 0 0 1 16 0zM8 4a.905.905 0 0 0-.9.995l.35 3.507a.552.552 0 0 0 1.1 0l.35-3.507A.905.905 0 0 0 8 4zm.002 6a1 1 0 1 0 0 2 1 1 0 0 0 0-2z" />
            </svg>
            Your password was not updated, since the provided current password
            does not match.
          </div>
          ...
          />
          <div
            id="changePass-new-password-message"
            className="changePass-message"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
          ...
          <div
            id="changePass-new-password-message-2"
            className="changePass-message"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
            ...
            Your new password is the same as your old password. Please enter
            again.
          </div>
          ...
          />
          <div
            id="changePass-con-password-message"
            className="changePass-message"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
